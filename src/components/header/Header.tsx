...
const Header = (props:any) => {
    ...
    return (
        <div className="header fixed lg:sticky lg:border-b-2 lg:border-base-200 lg:mb-1 z-10  w-full top-0 backdrop-blur-sm bg-white/30 lg:backdrop-blur-none lg:bg-base-100 flex items-center lg:w-full justify-between max-w-full">
            ...
            <div className={"lg:ml-auto prose lg:mr-8 flex max-h-full"}>
                <ThemeChange></ThemeChange>
                <label className="swap swap-rotate w-[3rem] h-[3rem] hidden">
